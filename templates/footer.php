    ...
    <div class="footer-top py-5 text-light" style="background:linear-gradient(135deg,#0d6efd,#7b61ff);">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h6>Kontakt</h6>
            <p class="small mb-1">Andreas Pareigis Stiftung</p>
            <p class="small mb-1">Meinern 15a, 29614 Soltau</p>
            <p class="small">E-Mail: <a class="text-light" href="mailto:<?php echo ADMIN_EMAIL; ?>"><?php echo ADMIN_EMAIL; ?></a></p>
          </div>
        </div>
      </div>
    </div>
